...
Leap 15.6, openSUSE Tumbleweed, Debian12, Ubuntu 22.04 and Ubuntu 24.04.
...
1. Fetch the Vagrant box, per default this is `cloud-image/ubuntu-22.04`, using `vagrant box
   add cloud-image/ubuntu-22.04`.
